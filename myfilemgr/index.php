   ...
   font-size: 20px;
	...
	<div class="alert alert-info">
			...
			<tr><td><form enctype="multipart/form-data"  action="" id="wb_Form1" name="form" method="post">
					...
					<a href="upload-form.php" class="btn btn-danger">Upload</a></td>
					<td>
			</form></tr></td></table>
							 <div class="col-md-18">
			...
			<div class="panel-body">
				<div class="table-responsive">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-condensed" id="example">
                            ...
                            <tbody>
							<?php 
							$query=mysqli_query($conn,"select * from gamedata ORDER BY id DESC")or die(mysqli_error($conn));
							...
							?>
										...
										<td>
				<!-- <a href="download.php?filename=<?php echo $game;?>" title="click to download"><span class="glyphicon glyphicon-paperclip" style="font-size:20px; color:blue"></span></a> -->
