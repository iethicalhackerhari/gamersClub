...
<table class="t "><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `quiz` where id='$c'"; 
...
<tr><td><h3><br><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 6){ ?>
 ...
 <h2>Result</h2>
 <div class="t">No. of Correct Answer:&nbsp;<?php echo $no = @$_SESSION['score']; 
 session_unset(); ?></div><br>
 <div class="t">Your Score:&nbsp<?php echo $no*2; ?></div>
<?php } ?>
